...
public class Regex {
    public static void main(String[] args) {
        ...
        // Provide the pattern
        pattern = Pattern.compile("(?=.*[!@#$%&*()\\-+=^.|_])[^ÑñSsCc].{6,}");
        ...
        pattern = Pattern.compile("\\d[64][a-zA-Z].{10,}(gmail\\.com)");
        ...
        // Provide regex pattern
        pattern = Pattern.compile("(http://)?(www\\.)\\w+(\\.com)(/settings)?");
        ...
        tweet = tweet.replaceAll("(\\W(#McDStories))", "");
